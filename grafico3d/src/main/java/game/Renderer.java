...
// essa classe de fato fala o que a placa grafica vai renderizar
// e atualiza os objetos
public class Renderer {
	...
	public void render(Window window, Camera camera, GameItem[] gameItems, Vector3f ambientLight,
		...
		// pequena gambiarra
		// renderiza o sol ( faz com que a luz ambiente n defina a cor do sol)
		// aqui que move o sol e provavelmente deveria estar em updates
		renderLights(viewMatrix, new Vector3f(1,1,1), pointLightList, spotLightList, directionalLight);
		gameItems[0].move(0.5f);	
		Mesh mesh2 = gameItems[0].getMesh();
		// Set model view matrix for this item
		Matrix4f modelViewMatrix2 = transformation.getModelViewMatrix(gameItems[0], viewMatrix);
		shaderProgram.setUniform("modelViewMatrix", modelViewMatrix2);
		// Render the mesh for this game item
		shaderProgram.setUniform("material", mesh2.getMaterial());
		mesh2.render();
		...
		for (int i = 1; i< gameItems.length;i++) {
			//aqui que move o objeto e provavelmente deveria estar em updates
